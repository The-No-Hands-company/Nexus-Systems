...
Effect: Overdrive
Category: distortion
File: dawg/dsp/distortion/Overdrive.h
...
/**
 * @brief Warm tube-style overdrive distortion
 * 
...
public:
    ...
    Overdrive(const Overdrive&) = delete;
    Overdrive& operator=(const Overdrive&) = delete;
...
private:
    ...
    // TODO: Add specific parameters for Overdrive
