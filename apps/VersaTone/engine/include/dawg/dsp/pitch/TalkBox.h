...
/**
 * @brief Talk box vocal effect simulation
 * 
...
public:
    ...
    TalkBox(const TalkBox&) = delete;
    TalkBox& operator=(const TalkBox&) = delete;
    TalkBox(TalkBox&&) = default;
    TalkBox& operator=(TalkBox&&) = default;
...
private:
    ...
    // TODO: Add specific parameters for TalkBox
