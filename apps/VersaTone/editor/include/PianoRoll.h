...
/**
 * @brief PianoRoll displays and edits MIDI notes for a MidiClip.
 *
 * See: include/Timeline.h for MidiClip definition.
 */
...
public:
    ...
    /**
     * @brief Set the backend MidiClip to display and edit.
     * @param clip Shared pointer to MidiClip instance.
     */
    void setMidiClip(std::shared_ptr<dawg::core::MidiClip> clip);
...
private:
    std::shared_ptr<dawg::core::MidiClip> m_clip;
