...
/**
 * @brief Loads 16/24/32-bit PCM WAV files into dawg::core::Audiobuffer (mono/stereo).
 */
class WavLoader {
public:
    static bool load(const std::string& filename, dawg::core::Audiobuffer& buffer, uint32_t& sampleRate);
};
