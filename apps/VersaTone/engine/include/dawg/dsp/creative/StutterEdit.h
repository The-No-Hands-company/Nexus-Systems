...
Effect: StutterEdit
Category: creative
File: dawg/dsp/creative/StutterEdit.h
...
/**
 * @brief Rhythmic stuttering and gating
 * 
...
public:
    ...
    StutterEdit(const StutterEdit&) = delete;
    StutterEdit& operator=(const StutterEdit&) = delete;
    StutterEdit(StutterEdit&&) = default;
    StutterEdit& operator=(StutterEdit&&) = default;
...
private:
    ...
    // TODO: Add specific parameters for StutterEdit
