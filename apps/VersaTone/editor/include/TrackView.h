...
/**
 * @brief TrackView displays and manages timeline clips (audio/MIDI).
 *
 * See: include/Timeline.h for Timeline/Clip classes.
 */
...
public:
    ...
    void setTimeline(std::shared_ptr<dawg::core::Timeline> timeline);

    /**
     * @brief Add a new clip to the timeline.
     * @param clip Shared pointer to Clip instance.
     */
    void addClip(std::shared_ptr<dawg::core::Clip> clip);

    /**
     * @brief Remove the selected clip from the timeline.
     */
    void removeSelectedClip();

    /**
     * @brief Duplicate the selected clip.
     */
...
private:
    std::shared_ptr<dawg::core::Timeline> m_timeline;

    int m_selectedClipIdx = -1;
    bool m_dragging = false;
    bool m_resizing = false;
    QPoint m_dragStartPos;
    double m_originalClipPos = 0.0;
    int m_resizeEdge = 0; // 0: none, -1: left, 1: right
    std::vector<int> m_multiSelectedClipIdxs;
};
