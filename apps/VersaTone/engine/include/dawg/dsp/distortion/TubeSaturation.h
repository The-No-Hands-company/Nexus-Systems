...
Category: distortion
File: dawg/dsp/distortion/TubeSaturation.h
...
/**
 * @brief Vacuum tube saturation simulation
 * 
...
public:
    ...
    TubeSaturation& operator=(TubeSaturation&&) = default;
...
private:
    ...
    // TODO: Add specific parameters for TubeSaturation
