...
|---|---|---|---|---|
| OBJ | import + export | all | 🟡 | **Export only** (ASCII) |
| PLY | import + export | all | 🟡 | Export only (ASCII); no binary |
| STL | import + export | all + CAD/print | ❌ | — |
| glTF 2.0 | import + export | all modern | ❌ | — |
...
**Verdict:** **the most glaring table-stakes gap.** No importer at all, and export is limited to ASCII OBJ/PLY. Every DCC lives or dies by interchange; this blocks real-world use.
...
1. **Interchange (L13)** — no importer, export limited to ASCII OBJ/PLY. Table-stakes; blocks real use.
...
- **IO importers + core formats:** OBJ/PLY/STL import; glTF 2.0 import+export; STL export. (L13)
