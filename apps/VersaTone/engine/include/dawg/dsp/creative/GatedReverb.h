...
Effect: GatedReverb
Category: creative
File: dawg/dsp/creative/GatedReverb.h
...
/**
 * @brief Gated reverb with envelope control
 * 
...
public:
    ...
    GatedReverb(const GatedReverb&) = delete;
    GatedReverb& operator=(const GatedReverb&) = delete;
    GatedReverb(GatedReverb&&) = default;
    GatedReverb& operator=(GatedReverb&&) = default;
...
private:
    ...
    // TODO: Add specific parameters for GatedReverb
