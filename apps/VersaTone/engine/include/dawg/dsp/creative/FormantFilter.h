...
Category: creative
File: dawg/dsp/creative/FormantFilter.h
...
public:
    ...
    FormantFilter& operator=(FormantFilter&&) = default;
...
private:
    ...
    // TODO: Add specific parameters for FormantFilter
