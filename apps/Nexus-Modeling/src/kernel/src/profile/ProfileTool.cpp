#include "nexus/profile2/ProfileTool.h"
#include <algorithm>
#include <cmath>
#include <limits>
#include <unordered_map>

namespace nexus::profile2 {
using Vec3 = nexus::render::Vec3;

std::vector<Vec3> ProfileTool::extractProfile(const geometry::Mesh& m, const Vec3& planePoint, const Vec3& planeNormal) {
...
geometry::Mesh ProfileTool::profileToCurve(const std::vector<Vec3>& profile) {
    geometry::Mesh mesh;
...
std::vector<std::vector<Vec3>> ProfileTool::extractAllProfiles(const geometry::Mesh& m, const Vec3& axis) {
