...
Effect: Harmonizer
Category: pitch
File: dawg/dsp/pitch/Harmonizer.h
...
/**
 * @brief Intelligent harmony generation
 * 
...
public:
    ...
    Harmonizer(const Harmonizer&) = delete;
    Harmonizer& operator=(const Harmonizer&) = delete;
    Harmonizer(Harmonizer&&) = default;
    Harmonizer& operator=(Harmonizer&&) = default;
...
private:
    ...
    // TODO: Add specific parameters for Harmonizer
