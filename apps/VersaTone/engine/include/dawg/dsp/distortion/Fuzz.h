...
Effect: Fuzz
Category: distortion
File: dawg/dsp/distortion/Fuzz.h
...
/**
 * @brief Vintage fuzz box distortion
 * 
...
public:
    ...
    Fuzz(const Fuzz&) = delete;
    Fuzz& operator=(const Fuzz&) = delete;
    Fuzz(Fuzz&&) = default;
    Fuzz& operator=(Fuzz&&) = default;
...
private:
    ...
    // TODO: Add specific parameters for Fuzz
