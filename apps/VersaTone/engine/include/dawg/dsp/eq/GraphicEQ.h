...
/**
 * @brief Multi-band graphic equalizer with visual feedback
 * 
...
public:
    ...
    GraphicEQ(const GraphicEQ&) = delete;
    GraphicEQ& operator=(const GraphicEQ&) = delete;
    GraphicEQ(GraphicEQ&&) = default;
    GraphicEQ& operator=(GraphicEQ&&) = default;
...
private:
    ...
    // TODO: Add specific parameters for GraphicEQ
