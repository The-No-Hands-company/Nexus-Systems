...
Category: creative
File: dawg/dsp/creative/ReverseReverb.h
...
public:
    ...
    ReverseReverb();
    ~ReverseReverb() = default;

    // Copy and move semantics
    ReverseReverb(const ReverseReverb&) = delete;
    ReverseReverb& operator=(const ReverseReverb&) = delete;
    ReverseReverb(ReverseReverb&&) = default;
    ReverseReverb& operator=(ReverseReverb&&) = default;
...
private:
    ...
    // TODO: Add specific parameters for ReverseReverb
