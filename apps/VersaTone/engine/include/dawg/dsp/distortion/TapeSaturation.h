...
Category: distortion
File: dawg/dsp/distortion/TapeSaturation.h
...
/**
 * @brief Analog tape saturation modeling
 * 
...
public:
    ...
    TapeSaturation(const TapeSaturation&) = delete;
    TapeSaturation& operator=(const TapeSaturation&) = delete;
    TapeSaturation(TapeSaturation&&) = default;
    TapeSaturation& operator=(TapeSaturation&&) = default;
...
private:
    ...
    // TODO: Add specific parameters for TapeSaturation
