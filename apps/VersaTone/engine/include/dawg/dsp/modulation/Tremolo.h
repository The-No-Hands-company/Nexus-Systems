...
Effect: Tremolo
Category: modulation
File: dawg/dsp/modulation/Tremolo.h
...
/**
 * @brief Amplitude modulation with multiple waveforms
 * 
...
public:
    ...
    Tremolo(const Tremolo&) = delete;
    Tremolo& operator=(const Tremolo&) = delete;
    Tremolo(Tremolo&&) = default;
    Tremolo& operator=(Tremolo&&) = default;
...
private:
    ...
    // TODO: Add specific parameters for Tremolo
