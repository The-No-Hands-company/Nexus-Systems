...
export function registerPackageRegistryMatrixRoutes(app: any) {
  ...
  app.post("/api/package-registry-matrix/stub", async ({ body }: any) =>
    entityResponse({ id: "package-matrix-stub", payload: body || {} }, "Package registry parity stub request accepted"));
}