...
export function registerIssueManagementFullDepthRoutes(app: any) {
  ...
  app.post("/api/issue-management-full-depth/stub", async ({ body }: any) =>
    entityResponse({ id: "issue-depth-stub", ...(body || {}) }, "Issue management depth parity stub request accepted"));
}