...
export function registerTechnicalDebtSkeeperRoutes(app: ForgeRouteApp) {
  app.get("/api/tech-debt/inventory", async () =>
    listResponse([], "Technical debt inventory and tracking"),
  );
  app.post("/api/tech-debt/log", async ({ body }) =>
