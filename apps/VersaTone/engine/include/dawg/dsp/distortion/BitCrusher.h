...
Effect: BitCrusher
Category: distortion
File: dawg/dsp/distortion/BitCrusher.h
...
/**
 * @brief Digital bit reduction and distortion
 * 
...
public:
    ...
    BitCrusher& operator=(BitCrusher&&) = default;
...
private:
    ...
    // TODO: Add specific parameters for BitCrusher
