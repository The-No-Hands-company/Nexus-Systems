...
Category: creative
File: dawg/dsp/creative/GranularDelay.h
...
/**
 * @brief Granular synthesis-based delay
 * 
...
public:
    ...
    GranularDelay(const GranularDelay&) = delete;
    GranularDelay& operator=(const GranularDelay&) = delete;
    GranularDelay(GranularDelay&&) = default;
    GranularDelay& operator=(GranularDelay&&) = default;
...
private:
    ...
    // TODO: Add specific parameters for GranularDelay
