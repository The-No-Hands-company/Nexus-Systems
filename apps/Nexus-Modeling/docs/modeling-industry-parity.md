...
| Stable element IDs across ops | 🟡 Partial | Present in ~12 ops (`rebuildStableElementIds`); **sweep found 3 gaps** — `EdgeBridge`, `MeshFillet`, `ModifierStack` build output meshes without rebuilding IDs (follow-up) |
